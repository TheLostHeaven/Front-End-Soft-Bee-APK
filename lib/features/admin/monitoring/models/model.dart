// Modelos de datos completos y mejorados
import 'dart:convert';
...
class Monitoreo {
  ...
  final List<MonitoreoRespuesta> respuestas;
  ...
  factory Monitoreo.fromJson(Map<String, dynamic> json) {
    return Monitoreo(
      id: json['id'] ?? 0,
      idColmena: json['id_colmena'] ?? json['hive_id'] ?? 0,
      idApiario: json['id_apiario'] ?? json['apiary_id'] ?? 0,
      fecha: DateTime.parse(
        json['fecha'] ?? json['date'] ?? DateTime.now().toIso8601String(),
      ),
      respuestas: json['respuestas'] != null
          ? (json['respuestas'] as List)
                ...
                .toList()
          : [],
      sincronizado: json['sincronizado'] ?? json['synced'] ?? false,
      datosAdicionales: json['datos_adicionales'] ?? json['additional_data'],
    );
  }
