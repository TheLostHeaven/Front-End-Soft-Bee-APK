        ...
        body: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              _buildDetailRow('Fecha de Creación:', user.createdAt.toLocal().toString().split('.')[0]),
              _buildDetailRow('Última Actualización:', user.updatedAt.toLocal().toString().split('.')[0]),
              ...
              if (user.apiaries.isNotEmpty) ...[
                ...
                SizedBox(height: 8),
                ...user.apiaries.map((apiary) => Padding(
